...
motherRouter.get(
  "/category/:id/article",
  UserController.fetchArticleBasedOnCategory
);

motherRouter.post(
  "/category/:id/article",
  UserController.addArticlesBasedOnCategory
);

motherRouter.get(
  "/categoryMonth/:id",
  UserController.fetchArticleBasedOnCategoryMonth
);
motherRouter.post(
  "/categoryMonth/:id",
  UserController.addArticleBasedOnCategoryMonth
);
